...
//Using @controllerAdvice
	 ...
	 * ResponseEntity<ErrorMessage>(message, HttpStatus.NOT_FOUND); }
	 * 
	 * @ExceptionHandler(Exception.class) public ResponseEntity<ErrorMessage>
	 ...
	 * Date(), ex.getMessage(), request.getDescription(false)); return new
	 * ResponseEntity<ErrorMessage>(message, HttpStatus.INTERNAL_SERVER_ERROR); }
	 */
